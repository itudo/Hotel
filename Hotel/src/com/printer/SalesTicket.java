...
public class SalesTicket  implements Printable{
	...
	private String operatorName="张惠"; //操作员
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
		...
		//设置小票的标题标题  
		g2.drawString("Starry Sky 酒店",(float)x+25,(float)y+heigth); 
		...
		line+=2;
		//设置操作员 
		g2.drawString("操作员:"+"张惠",(float)x+20,(float)y+line); 
		line+=heigth;
...
/*
		...
		line += heigth; 
		g2.drawString("Starry sky酒店欢迎您的下次光临 ",(float)x+15,(float)y+line);
		switch (pageIndex) {  
		case 0:  
